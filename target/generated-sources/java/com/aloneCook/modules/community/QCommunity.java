...
public class QCommunity extends EntityPathBase<Community> {
    ...
    private static final long serialVersionUID = 1782919493L;
    ...
    public final com.aloneCook.modules.bbs.QBbs bbs;
    ...
    public QCommunity(Class<? extends Community> type, PathMetadata metadata, PathInits inits) {
        ...
        this.bbs = inits.isInitialized("bbs") ? new com.aloneCook.modules.bbs.QBbs(forProperty("bbs"), inits.get("bbs")) : null;
